...
def group_by_type(df_test):
    ...
    X_test1 = min_max_scaler.fit_transform(df11)
    X_test2 = min_max_scaler.fit_transform(df12)
    X_test3 = min_max_scaler.fit_transform(df13)
    X_test4 = min_max_scaler.fit_transform(df14)
    X_test5 = min_max_scaler.fit_transform(df15)
    X_test6 = min_max_scaler.fit_transform(df16)
    X_test7 = min_max_scaler.fit_transform(df17)
    X_test8 = min_max_scaler.fit_transform(df18)
