...
df1 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df1.csv")
df2 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df2.csv")
df3 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df3.csv")
df4 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df4.csv")
df5 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df5.csv")
df6 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df6.csv")
df7 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df7.csv")
df8 = pd.read_csv("//Users/simonholmes/molecular_properties/submission_LGBM_df8.csv")
...
df5.drop(['type'], axis=1, inplace=True)
...
df6.drop(['type'], axis=1, inplace=True)
...
df_submissiom.to_csv('//Users/simonholmes/molecular_properties/submission_regression_LGBM.csv', index=False)
